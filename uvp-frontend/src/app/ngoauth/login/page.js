  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 font-sans overflow-hidden relative">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-[-10%] left-[-10%] w-[600px] h-[600px] bg-purple-600/10 rounded-full blur-[120px] delay-1000 animate-pulse" />
      </div>
      ...
      >
        <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-indigo-900/10 p-8 md:p-10 border border-white/50">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-slate-900 tracking-tight">Organization Portal</h2>
            <p className="mt-2 flex items-center justify-center gap-2 text-slate-500 font-medium">
          ...
          <div className="mt-8 text-center">
            <p className="text-slate-500 text-sm font-medium">
              New Organization?{" "}
              <Link href="/ngoauth/signup" className="text-indigo-600 hover:text-indigo-700 font-bold hover:underline transition-all">
                Create Account
              </Link>
            </p>
          </div>
